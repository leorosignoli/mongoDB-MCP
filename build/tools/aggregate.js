import { sanitizeAggregationPipeline, sanitizeCollectionName, sanitizeDatabaseName, } from '../mongodb/safety.js';
export async function executeAggregation(connection, args) {
    try {
...
export function validateAggregationPipeline(pipeline) {
